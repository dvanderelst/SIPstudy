...
We provide a `requirements.txt` file listing the python packages installed in the python environment we used the analyze the data. The same information is also provided as a `yml` file: `requirements.yml`.
